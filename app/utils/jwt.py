...
class JWT:
    ...
    def create_refresh_token(subject: str):   
        ...
        encoded_jwt = jwt.encode(payload, settings.authjwt_secret_key, algorithm=settings.authjwt_algorithm)
        return encoded_jwt
    ...
    @staticmethod
    def verify_token_and_get_sub(token: str):
        return JWT.verify_token(token).get('sub')
